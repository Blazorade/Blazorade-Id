...
- Removed references to Blazored libraries. Turned out that all Blazored libraries where archived and deprecated on the same day as we published the initial v1.0.0 of Blazorade ID. Blazored libraries have been replaced with JS Interop in Blazorade ID.
