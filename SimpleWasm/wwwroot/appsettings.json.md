...
- `enablesilentauthorizationcodeflow`: A boolean value indicating whether to enable silent authorization code flow. Set to `true` to enable or `false` to disable silent authorization code flow.
