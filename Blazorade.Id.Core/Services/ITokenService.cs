...
namespace Blazorade.Id.Services
{
    ...
    public interface ITokenService
    {
        ...
        /// </remarks>
        Task<AccessTokenDictionary> GetAccessTokensAsync(GetTokenOptions? options = null, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        Task<JwtSecurityToken?> GetIdentityTokenAsync(GetTokenOptions? options = null, CancellationToken cancellationToken = default);
    }
}
